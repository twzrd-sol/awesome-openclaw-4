...
| **[TWZRD Agent Intel](https://intel.twzrd.xyz)** | Trust scoring MCP for AI agents on Solana. Verify agent wallet reputation before x402 micropayments. Free: `score_agent`, `preflight_check`. Paid: `get_trust_receipt` (x402). Config: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}` | [intel.twzrd.xyz](https://intel.twzrd.xyz) |
